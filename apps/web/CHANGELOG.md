...
- b7872d6: Give an online match a visible board. The pitch is a size container and takes its height
...
- ddb629a: Fix the online screens in light mode. They painted no page surface of their own, so on a
